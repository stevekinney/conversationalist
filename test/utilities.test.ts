...
import type { Conversation, Message, MessageJSON } from '../src/types';
import {
  fromMarkdown,
  hasOwnProperty,
  MarkdownParseError,
...
describe('utilities: toMultiModalArray / normalizeContent', () => {
  test('toMultiModalArray converts strings and wraps single objects', () => {
  ...
  test('normalizeContent returns undefined/string/array appropriately', () => {
...
describe('utilities: hasOwnProperty', () => {
...
describe('utilities: pairToolCallsWithResults', () => {
...
describe('utilities: fromMarkdown', () => {
...
describe('utilities: toMarkdown/fromMarkdown round-trip', () => {
